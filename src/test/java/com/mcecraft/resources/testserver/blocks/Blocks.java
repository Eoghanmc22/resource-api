...
public class Blocks {
    ...
    public static final Blocks TEST = new Blocks(ResourceApi.create(SpawnerBlockType.INSTANCE, NamespaceID.from("demo:test_block"))
            .model(JsonProvider.of(Path.of("resources/models/demo_block.json")))
            .include(b -> b.file(Utils.resourcePath(NamespaceID.from("demo:texture2"), Utils.TEXTURES), Path.of("resources/textures/texture2.png")))
            .build()
    );
    ...
    public static final Blocks TEST2 = new Blocks(ResourceApi.create(RealBlockResourceType.INSTANCE, NamespaceID.from("demo:test_block2"))
            .model(JsonProvider.of(Path.of("resources/models/demo_block2.json")))
            .include(b -> b.file(Utils.resourcePath(NamespaceID.from("demo:texture3"), Utils.TEXTURES), Path.of("resources/textures/texture3.png")))
